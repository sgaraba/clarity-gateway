...
import md.bma.imserv.gateway.config.Constants;
import md.bma.imserv.gateway.GatewayApp;
import md.bma.imserv.gateway.domain.Authority;
import md.bma.imserv.gateway.domain.User;
import md.bma.imserv.gateway.repository.AuthorityRepository;
import md.bma.imserv.gateway.repository.UserRepository;
import md.bma.imserv.gateway.security.AuthoritiesConstants;
import md.bma.imserv.gateway.service.MailService;
import md.bma.imserv.gateway.service.dto.UserDTO;
import md.bma.imserv.gateway.service.dto.PasswordChangeDTO;
import md.bma.imserv.gateway.web.rest.errors.ExceptionTranslator;
import md.bma.imserv.gateway.web.rest.vm.KeyAndPasswordVM;
import md.bma.imserv.gateway.web.rest.vm.ManagedUserVM;
import md.bma.imserv.gateway.service.UserService;
