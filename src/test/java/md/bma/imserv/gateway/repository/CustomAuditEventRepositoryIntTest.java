package md.bma.imserv.gateway.repository;

import md.bma.imserv.gateway.GatewayApp;
import md.bma.imserv.gateway.config.Constants;
import md.bma.imserv.gateway.config.audit.AuditEventConverter;
import md.bma.imserv.gateway.domain.PersistentAuditEvent;
...
import static md.bma.imserv.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
